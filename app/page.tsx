...
const drilldowns: Record<string, { eyebrow:string; title:string; value:string; summary:string; rows:[string,string][]; assumption:string; action:string; source:string }> = {
  ...
  "tf-engine": { eyebrow:"Growth Formula", title:"Talent Formula FY26/27 revenue", value:"$13.3M", summary:"Talent Formula is the Growth Formula, combining recruitment capability with geographic expansion.", rows:[["FY25/26 revenue","$9.6M"],["FY26/27 revenue","$13.3M"],["FY28/29 revenue","$26.8M"],["Four-year CAGR","41.3%"]], assumption:"The UK plan requires a 79% year-on-year increase and stronger named pipeline coverage.", action:"Appoint the UK Growth Lead and reach 1.5× qualified coverage before Q2 lock.", source:"Dashboard + executive analysis · TF plan" },
  "ai-engine": { eyebrow:"Margin Magic", title:"AI Digital FY26/27 revenue", value:"$2.13M", summary:"AI Digital is Margin Magic: recurring platform economics distributed through the existing client base.", rows:[["Gross profit","$1.165M"],["Gross margin","54.6%"],["EBITDA","$590k"],["June run-rate MRR","$242,483"]], assumption:"Expected case assumes 124 phased activations: TF and FA from September, Backroom from January.", action:"Gate incremental opex against the monthly conversion funnel and treat September MRR below $150k as an early warning.", source:"AI Pricing Model · Budget-verified totals" },
