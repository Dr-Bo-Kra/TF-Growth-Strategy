...
const strategyThemes = [
  ...
  { keywords:["why now","timing","market window","shortage"], answer:"The plan is timely because accounting talent shortages are structural, outsourcing adoption is established, and Talent Formula has specialist delivery capacity, a proven recruitment engine and an AI proposition ready at the same time. The survey strengthens the timing case: 95% enablement and 95% teamwork suggest the organisation does not need a cultural turnaround before scaling.", sources:["C-Level Executive Analysis · Why Now", "TF Satisfaction Survey 2025 · Enablement and Teamwork"] },
  { keywords:["why us","advantage","moat","different","win"], answer:"Talent Formula’s advantage is the combination, not any single asset. Accounting specialisation protects quality; the recruitment engine supplies scarce talent; trusted client relationships provide distribution; and AI Digital adds recurring economics. The survey adds a harder-to-copy execution moat: 87% overall satisfaction, 95% enablement and 95% teamwork.", sources:["C-Level Executive Analysis · Why Talent Formula is positioned to win", "TF Satisfaction Survey 2025 · Executive strengths"] },
  { keywords:["culture","people","survey","employee","readiness"], answer:"The culture is an enabler of the growth case, not the constraint. With 99% participation, the survey provides a highly representative organisational signal: 87% overall satisfaction, 95% enablement, 95% teamwork and 94% work-life blend. Management’s task is to preserve that advantage during rapid hiring and integration through clearer careers, recognition, two-way communication and visible follow-through.", sources:["TF Satisfaction Survey 2025 · 99% participation · 153 responses"] },
  ...
  return <main className={`section-${active}`}>
    ...
    <section id="people" className="chapter people-section">
      ...
      <div className="people-hero">
        <div><p className="people-kicker">2025 employee satisfaction · 99% participation</p><h2>The culture is ready to scale.<br/><em>A proven advantage for the growth plan.</em></h2><p className="people-lede">Near-total participation makes this a highly representative organisational signal. Employee sentiment confirms that Talent Formula already has the enablement, ownership and workplace connection required to execute its growth strategy. The priority is to preserve this cultural advantage as the group adds people, markets and new technology.</p></div>
      ...
      <div className="people-proof">
        <article><b>99%</b><span>survey participation</span></article><article><b>153</b><span>employee responses</span></article><article><b>95%</b><span>enablement</span></article><article><b>+11</b><span>teamwork points above benchmark</span></article>
      </div>
      ...
      <div className="people-board-note"><div><small>Culture as a growth asset</small><p><b>A strong foundation for execution.</b> High enablement, ownership and workplace connection give Talent Formula the organisational capacity to scale its specialist accounting, recruitment and AI growth engines. The Board’s role is to protect this advantage as the group expands.</p></div><a href="./sources/tf-satisfaction-survey-2025.pptx" download>View source survey <span>↓</span></a></div>
      <p className="people-source">Source: TF Satisfaction Survey 2025. Participation: 99%; driver items n=152–153. The survey cover cites an 83% benchmark; the detailed factor table cites 84%, so this view uses the factor-table benchmark and flags the discrepancy.</p>
    </section>
