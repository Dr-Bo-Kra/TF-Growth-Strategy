...
const drilldowns: Record<string, { eyebrow:string; title:string; value:string; summary:string; rows:[string,string][]; assumption:string; action:string; source:string }> = {
  ...
  "ebitda-26": { eyebrow:"FY2026/27", title:"Full-group post-synergy EBITDA", value:"$5.74M", summary:"The full-group result combines TF+FA EBITDA, AI Digital EBITDA and the annual synergy register, producing a 13.7% margin.", rows:[["TF + FA pre-synergy EBITDA","$3.500M"],["AI Digital EBITDA","$0.590M"],["Annual synergy register","$1.650M"],["Full-group EBITDA","$5.740M"],["Group margin","13.7%"]], assumption:"AI Digital is separate from the $3.50M TF+FA result. Synergies must be tracked separately from underlying entity performance.", action:"Report TF+FA, AI Digital and realised synergies as separate bridge lines every month.", source:"Executive analysis · Sections 07 and 10 + AI Pricing Model" },
