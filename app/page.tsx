...
const strategyThemes = [
  ...
  { keywords:["culture","people","survey","employee","readiness"], answer:"The culture is an enabler of the growth case, not the constraint. The survey records 87% overall satisfaction, 95% enablement, 95% teamwork and 94% work-life blend. Management’s task is to preserve that advantage during rapid hiring and integration through clearer careers, recognition, two-way communication and visible follow-through.", sources:["TF Satisfaction Survey 2025 · 153 responses"] },
...
export default function Home() {
  ...
  return <main className={`section-${active}`}>
    ...
    <section id="people" className="chapter people-section">
      ...
      <p className="people-source">Source: TF Satisfaction Survey 2025. Driver items n=152–153. The survey cover cites an 83% benchmark; the detailed factor table cites 84%, so this view uses the factor-table benchmark and flags the discrepancy.</p>
    </section>
